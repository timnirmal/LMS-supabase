        ...
        <div className={`card ${className}`} {...props}>
            ...
            <div
                ...
                <div className="flex flex-wrap">
                    ...
                    <div className="w-full w-1/2 mb-4 p-4 pl-2 pb-0 pt-2">
                        <a href="#">
                            <img src={props.Item2Image} className="object-cover rounded-2xl" alt=""/>
                        </a>
                        <a href="#">
                            <h5 className="text-sm text-gray-900 dark:text-white pt-2 pl-1">{props.Item2}</h5>
                        </a>
                    </div>
                    {/*<div className="w-full w-1/2 pl-5 pr-2 pb-1 ">
                        <a href="#">
                            <h5 className="text-sm text-gray-900 dark:text-white">T-Shirts</h5>
                        </a>
                    </div>
                    <div className="w-full w-1/2 pl-5 pr-2 pb-2">
                        <a href="#">
                            <h5 className="text-sm text-gray-900 dark:text-white">T-Shirts</h5>
                        </a>
                    </div>*/}
                    <div className="w-full w-1/2 mb-4 p-4 pr-2 pt-0">
                        <a href="#">
                            <img src={props.Item3Image} className="object-cover rounded-2xl" alt=""/>
                        </a>
                        <a href="#">
                            <h5 className="text-sm text-gray-900 dark:text-white pt-2 pl-1">{props.Item3}</h5>
                        </a>
                    </div>
                    <div className="w-full w-1/2 mb-4 p-4 pl-2 pt-0">
                        <a href="#">
                            <img src={props.Item4Image} className="object-cover rounded-2xl" alt=""/>
                        </a>
                        <a href="#">
                            <h5 className="text-sm text-gray-900 dark:text-white pt-2 pl-1">{props.Item4}</h5>
