...
export default function ReviewDisplay({children, className, ...props}) {
    ...
    for (let i = 1; i <= props.rating; i++) {
        fullStars.push(
            <svg fill="currentColor" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                 className={"w-4 h-4 " + (props.color)} viewBox="0 0 24 24">
    ...
    if (props.rating % 1) {
        const halfStar: JSX.Element = (
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                 className={"bi bi-star-half " + (props.color)} viewBox="0 0 16 16">
                <path
